...
import com.vieceli.pontointeligente.api.utils.PasswordUtils;

@RestController
@RequestMapping("/api/cadastrar-pj")
@CrossOrigin(origins = "*") //permitir q requisições de diferentes lugares (pode colocar o dominio q conhece)
